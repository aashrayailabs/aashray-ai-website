...
type Tab = "Overview" | "Policy Intelligence" | "WhatsApp Operations" | "Analytics" | "Infrastructure";
...
export default function FinancialAdvisorsShowcase() {
  ...
  const pipelineNodes = [
    ...
    { icon: FileText, label: "Policy Gen" },
    { icon: ShieldCheck, label: "Underwriting" },
    { icon: Repeat, label: "Renewal Tracking" },
    ...
    <div className="w-full bg-[#030303] rounded-xl border border-white/10 overflow-hidden shadow-[0_0_80px_rgba(6,182,212,0.05)] flex flex-col md:flex-row h-[800px] font-sans">
      ...
      <div className="w-full md:w-64 bg-[#080808] border-r border-white/5 flex flex-col shrink-0">
        <div className="p-5 border-b border-white/5">
          ...
          <p className="text-[10px] text-gray-500 font-mono">Financial & Insurance Ops</p>
        </div>
        
        <div className="p-3 flex-1 space-y-1">
          {["Overview", "Policy Intelligence", "WhatsApp Operations", "Analytics", "Infrastructure"].map((tab) => (
            <button
              key={tab}
            ...
            >
              ...
              {tab === "Policy Intelligence" && <Server className="w-4 h-4" />}
        ...
        <div className="p-5 border-t border-white/5 bg-[#050505]">
          ...
          <p className="text-xs text-gray-600 leading-tight">
            Operate and scale your business from anywhere through intelligent automation systems accessible from mobile and desktop environments.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col bg-[#020202] relative overflow-hidden">
        ...
        <div className="grid grid-cols-3 gap-4 p-6 border-b border-white/5 relative z-10 bg-black/40 backdrop-blur-md">
          <div className="bg-[#0a0a0a] border border-white/5 rounded-lg p-4">
            <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mb-1">Policies Managed</p>
          ...
          <div className="bg-[#0a0a0a] border border-white/5 rounded-lg p-4 relative overflow-hidden">
            ...
            <p className="text-[10px] text-cyan-500 uppercase tracking-widest font-bold mb-1">AI Actions Today</p>
            <p className="text-2xl font-mono text-cyan-400">{aiActions.toLocaleString()}</p>
          </div>
          <div className="bg-[#0a0a0a] border border-white/5 rounded-lg p-4">
            <p className="text-[10px] text-gray-500 uppercase tracking-widest font-bold mb-1">Workflow Efficiency</p>
        ...
        <div className="flex-1 overflow-y-auto p-6 relative z-10">
          <AnimatePresence mode="wait">
                ...
                <div className="bg-[#050505] border border-white/5 rounded-xl overflow-hidden">
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-white/5 text-gray-300">
                      {[
                        { id: "POL-9931", user: "R. Sharma", status: "Maturity Approaching", action: "Schedule Call", color: "text-orange-400", bg: "bg-orange-400/10" },
                        { id: "POL-7124", user: "A. Patel", status: "Active", action: "None", color: "text-green-400", bg: "bg-green-400/10" },
                        { id: "POL-8992", user: "S. Gupta", status: "Pending Verification", action: "Parse Documents", color: "text-cyan-400", bg: "bg-cyan-400/10" },
                      ].map((row, i) => (
            ...
            {activeTab !== "Overview" && activeTab !== "Policy Intelligence" && (
              <motion.div
                key="other"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
