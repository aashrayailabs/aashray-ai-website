      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10 max-w-6xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/20 bg-cyan-500/5 mb-6 font-semibold">
            ...
            <span className="text-[10px] font-mono text-cyan-400 tracking-wider uppercase font-semibold">Security Architecture</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter text-white mb-6 font-display">
            Secure-by-Design <br /> <span className="text-zinc-550">AI Infrastructure</span>
          </h1>
            ...
            <div className="relative w-full aspect-[16/9] md:aspect-[21/9] bg-black/40 rounded-2xl border border-white/5 overflow-hidden flex flex-col justify-end p-6">
              ...
              <div className="flex justify-between items-center pt-4 border-t border-white/5 font-mono text-[9px] text-gray-500 w-full">
                <div className="flex items-center gap-2">
                  <Network className="w-3.5 h-3.5 text-cyan-505" />
        ...
        <section className="mb-20">
          <h3 className="text-xs font-mono text-cyan-400 tracking-widest uppercase mb-4 font-semibold">Operational Security Blueprint</h3>
          <h2 className="text-3xl font-bold tracking-tight text-white mb-12 font-display">Security Posture Matrix</h2>
 
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all flex flex-col justify-between">
              <div>
                <div className="w-10 h-10 rounded-lg bg-cyan-950/20 border border-cyan-500/20 flex items-center justify-center mb-6">
                  <EyeOff className="w-5 h-5 text-cyan-400" />
                </div>
                <h4 className="text-xl font-bold text-white mb-2 tracking-tight">Data Isolation &amp; Sovereignty</h4>
                <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-semibold mb-6">
              ...
              <ul className="space-y-3 font-semibold text-xs text-zinc-450">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> In-memory processing, stateless models.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Support for on-premise &amp; private VPC setups.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Zero model training on tenant payload logs.
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all flex flex-col justify-between">
              <div>
                ...
                <h4 className="text-xl font-bold text-white mb-2 tracking-tight">Access Control &amp; RBAC</h4>
                <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-semibold mb-6">
              ...
              <ul className="space-y-3 font-semibold text-xs text-zinc-455">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> JWT-based agent authorization keys.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Scoped API routes preventing lateral access.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> OpenID Connect (OIDC) integration ready.
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all flex flex-col justify-between">
              <div>
                ...
                <h4 className="text-xl font-bold text-white mb-2 tracking-tight">Cryptographic Trail Log</h4>
                <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-semibold mb-6">
              ...
              <ul className="space-y-3 font-semibold text-xs text-zinc-450">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Signed JSON ledger records for auditing.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Event hashes stored securely for external systems verification.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Automated compliance formatting outputs.
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all flex flex-col justify-between">
              <div>
                ...
                <h4 className="text-xl font-bold text-white mb-2 tracking-tight">Egress and Data Leak Guard</h4>
                <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-semibold mb-6">
              ...
              <ul className="space-y-3 font-semibold text-xs text-zinc-450">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Regular expression &amp; model-based PII scans.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Active egress payload size &amp; structure filters.
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-500" /> Automated system block on syntax drift anomalies.
                </li>
              </ul>
            </div>
        ...
        <section className="text-center py-16 border-t border-white/10">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white mb-4 font-display">Review Security Specifications</h2>
