...
export default function InfrastructurePage() {
  ...
  const deploymentSpecs = {
    vpc: {
      ...
      desc: "Deploy Aashray AI compute nodes inside your organization's own AWS, Google Cloud, or Microsoft Azure Virtual Private Clouds. Data residency is completely local to your subnets.",
      parameters: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10 max-w-6xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/20 bg-cyan-500/5 mb-6 font-semibold">
            ...
            <span className="text-[10px] font-mono text-cyan-400 tracking-wider uppercase font-semibold">Deployment Infrastructure</span>
          </div>
              ...
              >
                <div>
                  <div className="w-10 h-10 rounded-lg bg-cyan-950/20 border border-cyan-500/20 flex items-center justify-center mb-6">
                    {key === "vpc" && <Network className="w-5 h-5 text-cyan-400" />}
                    {key === "onprem" && <Server className="w-5 h-5 text-cyan-400" />}
                    {key === "saas" && <Zap className="w-5 h-5 text-cyan-400" />}
                  </div>
                  <h3 className="text-lg font-bold text-white mb-2 tracking-tight">{spec.title}</h3>
                  <p className="text-xs text-zinc-400 leading-relaxed font-semibold mb-6 text-justify">{spec.desc}</p>
                </div>
                ...
                <div className="pt-4 border-t border-white/10 flex justify-between items-center text-[10px] font-mono">
                  ...
                  <span className="text-cyan-400 font-bold uppercase">{key}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mb-20">
          <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-2xl relative overflow-hidden">
            <h3 className="text-xs font-mono text-cyan-400 tracking-widest uppercase mb-6 font-semibold">Node Specs &amp; Parameters</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h4 className="text-xl font-bold text-white mb-3 tracking-tight">{deploymentSpecs[activeDeployment].title} Spec</h4>
                <p className="text-xs sm:text-sm text-zinc-405 leading-[1.8] font-semibold text-justify mb-6">
                ...
                <div className="p-4 bg-[#080808] border border-white/5 rounded-2xl text-[10px] text-zinc-500 leading-relaxed">
              ...
              <div className="space-y-3 font-mono text-xs">
                {deploymentSpecs[activeDeployment].parameters.map((param, i) => (
                  <div key={i} className="p-4 bg-[#080808] border border-white/5 rounded-xl flex justify-between items-center">
                    <span className="text-zinc-400 font-semibold">{param.name}</span>
        ...
        <section className="mb-20">
          <h3 className="text-xs font-mono text-cyan-400 tracking-widest uppercase mb-4 font-semibold">Platform Security Guardrails</h3>
          <h2 className="text-3xl font-bold tracking-tight text-white mb-12">Built-in Security Mechanics</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all">
              ...
              <h4 className="text-lg font-bold text-white mb-3 tracking-tight">Stateless API Ingress</h4>
            ...
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all">
              ...
              <h4 className="text-lg font-bold text-white mb-3 tracking-tight">Isolated Execution Subnets</h4>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-semibold">
            ...
            <div className="p-8 rounded-3xl bg-[#050505] border border-white/5 shadow-lg hover:border-cyan-500/20 transition-all">
              ...
              <h4 className="text-lg font-bold text-white mb-3 tracking-tight">Immutable Ledger Logging</h4>
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed font-semibold">
        ...
        <section className="text-center py-16 border-t border-white/10">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white mb-4 font-display">Initialize Infrastructure Onboarding</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href="/contact" 
              className="w-full sm:w-auto px-6 py-3 text-xs font-bold uppercase tracking-wider bg-white text-black hover:bg-gray-200 transition-colors rounded-full text-center shadow-md animate-none"
            >
              Consult Engineering
            </Link>
            <Link 
            ...
            >
              Explore Aashray AI OS Platforms
            </Link>
          </div>
        </section>
