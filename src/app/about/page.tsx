...
export default function About() {
  return (
    <motion.div 
      ...
      className="relative pt-40 pb-32 px-6 md:px-12 container mx-auto overflow-hidden min-h-screen flex flex-col justify-center bg-[#faf9f6] text-zinc-700"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <motion.div
          ...
          className="mb-24"
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-8 tracking-tighter leading-[1.05] text-zinc-900 font-display">
            Building the <br className="hidden sm:block" /><span className="text-zinc-500">Automated Enterprise</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-650 max-w-3xl leading-relaxed font-medium">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 mt-20">
          ...
          <div className="lg:w-1/3 shrink-0 flex flex-col">
            <div className="flex flex-col items-start mb-10 pb-8 border-b border-zinc-200">
              <div className="w-32 h-32 md:w-40 md:h-40 shrink-0 relative">
                <div className="w-full h-full rounded-full border border-zinc-200 overflow-hidden relative z-10 bg-white shadow-sm">
                  <img 
                    src="/founder.jpg" 
              ...
              <h3 className="mt-5 text-xl font-bold text-zinc-950 tracking-tight">
                Akula Naveenkumar
              </h3>
              ...
              <p className="mt-2 text-[9px] uppercase tracking-widest text-zinc-400 font-mono font-bold leading-none">
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                <div key={i} className="relative p-5 bg-white border border-zinc-200 rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.01)] hover:border-zinc-300 transition-all duration-300">
                  <item.icon className="w-5 h-5 text-zinc-400 mb-4" />
                  <h4 className="text-zinc-950 font-bold mb-1 tracking-tight">{item.title}</h4>
          ...
          >
            <p className="text-[10px] text-zinc-555 font-mono tracking-widest uppercase font-bold pl-1">FOUNDER PHILOSOPHY</p>
            ...
            <div className="space-y-6 text-zinc-650 leading-relaxed text-sm sm:text-base font-medium max-w-2xl text-justify">
